...
以计算$O_2$电荷密度差为例，记录如何获得O2的Difference charge density。
...
电荷密度差分操作本可以在之前 [O2结构优化、自洽、非自洽](..\02.结构优化与静电自洽\02.vasp-opt.md) 自洽之后进行，但是之前的自洽没有规定FFT mesh，而电荷密度差分要求了，所以干脆从头算好了。
