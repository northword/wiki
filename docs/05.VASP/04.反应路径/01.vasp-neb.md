...
![初态结构优化后fin/CONTCAR](./assets/image-20210117152151485.png)
...
力不应当全是0，且学校机器调用VTST编译的VASP只能算一个插点，别的点都没动，还不清楚是程序编译问题还是参数设置问题。
...
修改PBS脚本文件的核数。数量是插点数量N的整数倍。

修改PBS脚本，使其调用VTST编译的VASP进行计算。
...
# This example
[zjb@op test-vasp-neb-IPOT=0]$ nebef.pl 
   0         0.000000      -224.399900         0.000000 
   1         0.000000      -224.069600         0.330300 
   2         0.000000      -222.953700         1.446200 
   3         0.000000      -222.366400         2.033500 
...
# This example
[zjb@op test-vasp-neb-IPOT=0]$ nebbarrier.pl && cat neb.dat
  0     0.000000     0.000000     0.000000   0
  1     0.419814     0.330336     0.000000   1
  2     0.844075     1.446219     0.000000   2
  3     1.273661     2.033531     0.000000   3
  4     1.680650     1.882893     0.000000   4
```
...
Forces and Energy:
   0         0.000000      -224.399900         0.000000 
   1         0.000000      -224.050500         0.349400 
   2         0.000000      -222.942200         1.457700 
   3         0.000000      -222.365700         2.034200 
   4         0.000000      -222.517000         1.882900 

Extremum 1 found at image  0.000000 with energy:  0.000000
Extremum 2 found at image  1.000000 with energy:  0.349411
Extremum 3 found at image  2.000000 with energy:  1.457780
Extremum 4 found at image  3.000000 with energy:  2.034241
Extremum 5 found at image  4.000000 with energy:  1.882893
```
...
3. 执行`nebef.pl`，并将`nebef.pl`结果（力和能量）写入`nebef.dat`。
...
具体见 [Nudged Elastic Band Scripts | VTST Tools](http://theory.cm.utexas.edu/vtsttools/scripts.html#nudged-elastic-band-scripts) 

其中mep.eps就是这样子：

![neb-N_graphene_O-mep-eps-error](./assets/neb-N_graphene_O-error.jpg)

## 其他

### VTST Script 中关于NEB的脚本
